            ...
            {!isSidebar && (
              <div className="flex items-center gap-1">
                <button 
                  ...
                  className="w-12 h-12 -mr-2 flex items-center justify-center hover:bg-rose-100 rounded-xl transition-colors text-slate-400 hover:text-rose-600 active:scale-95 select-none app-close-btn"
                  title="关闭"
                >
                  <X size={20} />
                </button>
