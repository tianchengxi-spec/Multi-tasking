    ...
    <div className="absolute top-12 left-12 flex flex-col items-start pointer-events-none select-none z-0">
      <div className="flex flex-col items-start">
        <div className="flex gap-2 items-baseline">
          ...
          <div className="text-[64px] font-light text-slate-800/90 leading-none tracking-tighter">
            {hours}
          </div>
          {/* text-4xl (36px) * 1.3 = ~47px -> text-5xl (48px) */}
          <div className="text-5xl font-light text-slate-400/40 leading-none tracking-tighter">
            :
          </div>
          <div className="text-[64px] font-light text-slate-800/90 leading-none tracking-tighter">
            {minutes}
        ...
        <div className="mt-3 flex flex-col items-start px-1">
          ...
          <span className="text-base font-bold text-slate-500 tracking-[0.15em] uppercase">
            {dayName}, {dateStr}
          </span>
        </div>
        
        {/* Slightly larger decorative glow */}
        <div className="absolute -inset-10 bg-blue-100/30 rounded-full blur-3xl -z-10 opacity-70"></div>
      </div>
    </div>
  );
};
